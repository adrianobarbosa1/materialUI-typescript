...
import { IListagemCidade, CidadesService } from "../../services/CidadesService";
      ...
      >
        <Table>
          ...
          <TableFooter>
            ...
            {totalCount > 0 && totalCount > Environment.LIMITE_LINHA && (
              <TableRow>
                <TableCell colSpan={3}>
                  <Pagination
                    page={pagina}
                    count={Math.ceil(totalCount / Environment.LIMITE_LINHA)}
                    onChange={(_, newPage) =>
                      setSearchParams(
